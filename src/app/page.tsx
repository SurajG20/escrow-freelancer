...
import { 
  ArrowRight, Lock, Shield, CheckCircle2, FileCheck, Users, Globe, 
  BarChart3, Smartphone, TrendingUp, Clock, AlertCircle, Star,
  Zap, DollarSign, Award, Play, Check
} from "lucide-react";
      ...
      <main>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-12">
              ...
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
                Streamline operations, boost productivity, and achieve your goals with our comprehensive platform designed for modern teams and freelancers.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link href="/login">
                  <Button size="lg" className="text-lg px-8 py-6 shadow-lg hover:shadow-xl transition-shadow bg-teal-600 hover:bg-teal-700">
                    Get Started Free
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Button>
                </Link>
                <Button variant="outline" size="lg" className="text-lg px-8 py-6 group border-teal-600 text-teal-700 hover:bg-teal-50">
                ...
                <CardContent className="p-0">
                  ...
                  <ul className="space-y-4 text-gray-700">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-lg">Streamline project management and workflows</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-lg">Secure payment processing with milestone tracking</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-lg">Reduce administrative overhead by 60%</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-lg">Scale operations with confidence</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
              <Card className="p-10 shadow-lg hover:shadow-xl transition-shadow border-2 border-gray-100">
                <CardContent className="p-0">
                  ...
                  <ul className="space-y-4 text-gray-700">
                    <li className="flex items-start gap-3">
                      <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-lg">Get paid securely and on time</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-lg">Professional project proposals and contracts</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-lg">Build credibility with verified reviews</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <Check className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-lg">Focus on work, not payment chasing</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
        ...
        <section id="how-it-works" className="py-24 px-6 bg-gradient-to-b from-gray-50 to-white">
          <div className="container mx-auto max-w-6xl">
            ...
            <p className="text-xl text-gray-600 text-center mb-16 max-w-2xl mx-auto">
              Get started in four simple steps and experience seamless project management
            </p>
        ...
        <section id="features" className="py-24 px-6 bg-white">
          <div className="container mx-auto max-w-6xl">
            ...
            <p className="text-xl text-gray-600 text-center mb-16 max-w-2xl mx-auto">
              Everything you need to manage projects and payments with confidence
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="p-8 hover:shadow-lg transition-shadow border border-gray-200">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Secure Escrow Protection</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Military-grade encryption for all transactions with blockchain security
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="p-8 hover:shadow-lg transition-shadow border border-gray-200">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Visual progress monitoring and detailed reporting for every project
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="p-8 hover:shadow-lg transition-shadow border border-gray-200">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Mutual Approval System</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Fair process protecting both parties with transparent workflows
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="p-8 hover:shadow-lg transition-shadow border border-gray-200">
                <CardContent className="p-0">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Global Payments</h3>
                  <p className="text-gray-600 leading-relaxed">
              ...
              <Card className="p-8 hover:shadow-lg transition-shadow border border-gray-200">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Manage projects anywhere with our responsive mobile interface
                  </p>
                </CardContent>
              </Card>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-10">
              ...
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Reduce Risk</h3>
                <ul className="space-y-3 text-gray-600">
                  <li className="flex items-start gap-2 justify-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-8 shadow-md border border-gray-200">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-700 mb-6 leading-relaxed">
                    "This platform has completely transformed how we manage freelance projects. Payment disputes are now a thing of the past, and our project completion rate increased significantly."
                  </p>
              ...
              <Card className="p-8 shadow-md border border-gray-200">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-700 mb-6 leading-relaxed">
                    "As a freelancer, getting paid on time was always a struggle. Now I have peace of mind knowing funds are secured before I start work. Game changer!"
                  </p>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Freelance Developer</p>
              ...
              <Card className="p-8 shadow-md border border-gray-200">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-700 mb-6 leading-relaxed">
                    "The milestone tracking and automated payments have saved us countless hours. We've scaled our operations significantly without adding administrative overhead."
                  </p>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Operations Lead</p>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Fully Transparent</h3>
                <p className="text-gray-600">Blockchain-verified transactions</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Active community and documentation</p>
              </div>
        ...
        <section className="py-32 px-6 bg-gradient-to-br from-teal-600 to-cyan-700 text-white">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Link href="/login">
                <Button size="lg" className="text-lg px-10 py-7 bg-white text-teal-700 hover:bg-gray-100 shadow-xl">
                  Get Started Now
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
            ...
            <div className="grid md:grid-cols-4 gap-12 mb-12">
              <div>
                ...
                <p className="text-sm mb-6 leading-relaxed">
                  Transform your business with secure, professional project management and payment solutions.
                </p>
                <div className="flex gap-4">
                  <Link href="#" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-gray-700 transition-colors">

...
export default function DashboardPage() {
    ...
    const stats = useMemo(() => {
        ...
        const totalValue = projects.reduce((sum, p) => {
            ...
            return sum + milestones.reduce((mSum, m) => mSum + parseFloat(m.amount || "0"), 0);
        }, 0);
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex items-start justify-between">
                <div>
                    <h1 className="text-base font-semibold text-slate-900 mb-1">Dashboard</h1>
                    <p className="text-sm text-slate-500">Welcome back, {address?.substring(0, 6)}...</p>
                </div>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                {isLoading ? (
                    Array.from({ length: 4 }).map((_, i) => (
                        <Card key={i} className="border border-slate-200/50 rounded-xl shadow-sm p-8">
                    ...
                    <>
                        <Card className="border border-slate-200/50 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 p-8">
                            ...
                            <CardContent className="p-0 space-y-1">
                                <div className="text-base font-semibold text-slate-900">{stats.totalLocked}</div>
                        ...
                        <Card className="border border-slate-200/50 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 p-8">
                            ...
                            <CardContent className="p-0 space-y-1">
                                <div className="text-base font-semibold text-slate-900">{stats.activeProjects}</div>
                        ...
                        <Card className="border border-slate-200/50 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 p-8">
                            ...
                            <CardContent className="p-0 space-y-1">
                                <div className="text-base font-semibold text-slate-900">{stats.pendingActions}</div>
                        ...
                        <Card className="border border-slate-200/50 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 p-8">
                            ...
                            <CardContent className="p-0 space-y-1">
                                <div className="text-base font-semibold text-slate-900">{stats.completedProjects}</div>
                            ...
                            {isLoading ? (
                                ...
                                <>
                                    <div className="space-y-2">
                                        ...
                                        <Progress 
                                            value={(projects.filter(p => p.status === "active").length / Math.max(projects.length, 1)) * 100}
                                            className="h-1"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <Progress 
                                            value={(projects.filter(p => p.status === "draft").length / Math.max(projects.length, 1)) * 100}
                                            className="h-1"
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <Progress 
                                            value={(projects.filter(p => p.status === "completed").length / Math.max(projects.length, 1)) * 100}
                                            className="h-1"
                                        />
                                    </div>
                                </>
                        ...
                        <CardContent className="p-0 space-y-3">
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="text-xs text-slate-500">Create escrow contract</div>
                                </div>

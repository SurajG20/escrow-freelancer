...
export default function NewProjectPage() {
  ...
  const validateStep1 = (): boolean => {
    ...
    if (!counterpartyWallet.trim()) {
      ...
      !counterpartyWallet.match(/^0x[a-fA-F0-9]{40}$/i) &&
      !counterpartyWallet.includes("@")
    ) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const clientWallet =
        role === "client"
          ? address.toLowerCase()
          : counterpartyWallet.toLowerCase();
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Secure your next engagement in 3 simple steps.
          </p>
        </div>
      </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    if (errors.counterpartyWallet)
                      setErrors({ ...errors, counterpartyWallet: "" });
                  }}
                />
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-4">
                  <Button
                    ...
                    className={cn(
                      "flex-1",
                      role === "client" && "border-accent bg-accent/5",
                    )}
                  ...
                  <Button
                    ...
                    className={cn(
                      "flex-1",
                      role === "freelancer" && "border-accent bg-accent/5",
                    )}
                        ...
                        <div className="flex justify-between font-bold">
                          ...
                          <div className="flex flex-col items-end gap-1">
                            {primaryCurrency.currency === "MIXED" ? (
                              ...
                              <span className="font-mono">
                                {(calculateTotal() + 0.001).toFixed(3)}{" "}
                                {nativeSymbol}
                              </span>
                            )}
                          </div>

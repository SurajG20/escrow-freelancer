...
import { Wallet, Mail, Smartphone, Loader2, CheckCircle2, AlertCircle } from "lucide-react";
    ...
    return (
        <div className="max-w-3xl space-y-6">
                    ...
                    {address ? (
                        <div className="flex items-center justify-between p-3 rounded-lg border border-slate-200 bg-white/40">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="font-mono text-sm">{address.substring(0, 6)}...{address.substring(38)}</div>
            ...
            <Card className="">
                ...
                <CardContent className="space-y-4">
                    {[
                        { title: "Email Notifications", desc: "Receive daily digests and major alerts", icon: Mail, on: false },

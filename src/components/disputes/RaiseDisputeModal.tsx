        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Describe the issue: e.g. deliverables not met, payment disagreement, scope mismatch..."
              className="w-full min-h-[120px] px-3 py-2 rounded-lg border border-slate-200 bg-white text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent resize-none"
              disabled={loading}
              required
            />
          </div>
